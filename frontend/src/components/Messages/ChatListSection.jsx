...
function ChatListSection({ label, sectionKey, chats, activeChatId, onSelect }) {
  return (
          ...
          return (
            ...
            >
              <div className="chat-list-top-row">
                ...
                <span className="text-muted-xs chat-list-time">
                  {formatTime(chat.lastMessageAt)}
                </span>
              </div>
              <p className="text-brand chat-list-person">{otherPerson}</p>
              <p className="text-muted-xs chat-list-preview">
